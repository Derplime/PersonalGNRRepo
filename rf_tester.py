...
class rf_tester(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Loopback Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Loopback Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rf_tester")
...
def main(top_block_cls=rf_tester, options=None):
