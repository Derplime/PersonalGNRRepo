...
# Title: Example from GNU Radio Wiki
...
class exampleUSRPFlowgraph(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Example from GNU Radio Wiki", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Example from GNU Radio Wiki")
        ...
        self.settings = Qt.QSettings("GNU Radio", "exampleUSRPFlowgraph")
...
def main(top_block_cls=exampleUSRPFlowgraph, options=None):
