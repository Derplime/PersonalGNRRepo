...
class rf_flowgraph_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Loopback Test 2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Loopback Test 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rf_flowgraph_2")
...
def main(top_block_cls=rf_flowgraph_2, options=None):
