...
# Title: N200 RF Tester w GNU Radio
...
class n200RFTester(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "N200 RF Tester w GNU Radio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("N200 RF Tester w GNU Radio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "n200RFTester")
        ...
        # Variables
        ##################################################
        self.uhd_samp_rate = uhd_samp_rate = 1000000
        ...
        self._uhd_samp_rate_range = Range(32000, 56000000, 10000, 1000000, 200)
        self._uhd_samp_rate_win = RangeWidget(self._uhd_samp_rate_range, self.set_uhd_samp_rate, "'uhd_samp_rate'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._uhd_samp_rate_win)
        ...
        self._uhd_center_freq_range = Range(70000000, 6000000000, 1000000, 100000000, 200)
    ...
    def set_uhd_center_freq(self, uhd_center_freq):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.uhd_center_freq, self.uhd_bw)
...
def main(top_block_cls=n200RFTester, options=None):
